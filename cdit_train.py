...
def main(cfg: DictConfig) -> None:
    ...
    for epoch in range(num_epochs):
        ...
        for batch_idx, frames in enumerate(progress_bar):
            ...
            prev_flat = prev_latents.view(B_prev, T_prev * H_prev * W_prev, C_prev)  # (B, T*4096, 4)
            ...
            t = timesteps.float().unsqueeze(1) / noise_scheduler.config.num_train_timesteps  # Normalized time
